...
const RegisterPage = () => {
      ...
      <div className="p-4 rounded-md bg-white">
        ...
        <form onSubmit={handleSubmit(handleRegisterFunc)}>
          ...
          <fieldset className="fieldset relative">
            ...
            <p>Minimum 6 characters containing <br></br> at least one uppercase and one lowercase letter</p>
  ...
  {errors.password && <p className='text-sm text-red-500'>{errors.password.message}</p>}
          ...
          <button className="btn btn-primary w-full">Register</button></form>
        <div className='flex justify-center items-center gap-2'>
          <Separator />
          <p className='whitespace-nowrap '>or sign up with</p>
          <Separator /></div>
        <button className='flex gap-2 btn btn-primary w-full' onClick={handleGoogleSignIn}>Signup with google <FaGoogle /></button>
